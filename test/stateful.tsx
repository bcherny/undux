...
//     render() {
//       return <div>{this.props.storeA.a}-{this.props.store.b}</div>
//     }
//   })
...
//         a={this.props.a.a * 4},
//         b={this.props.b.b.concat('d')},
//         c={this.props.c.c.d.toString()}
//         <button id='updateA' onClick={() => this.props.a.a = this.props.a.a + 10} />
//         <button id='updateB' onClick={() => this.props.b.b = this.props.b.b.toUpperCase()} />
//         <button id='updateC' onClick={() => this.props.c.c = { d: !this.props.c.c.d }} />
//       </>
//     }
//   })
...
//       return <>
//         {this.props.store.a}
//         <button id='a' onClick={() => this.props.store.a = this.props.store.a + 1} />
//         <button id='b' onClick={() => this.props.store.a = this.props.store.a - 1} />
//         {this.props.store.a > 0
...
//       return p.store.b !== this.props.store.b || true
//     }
//     render() {
//       renderCount++
//       return <>
...
//   let A = connect(store)(class extends React.Component<Props> {
//     shouldComponentUpdate(p: Props) {
//       return p.store.getState().b !== this.props.store.b || true
//     }
//     render() {
//       renderCount++
//       return this.props.store.a
//     }
//   })
//   withElement(A, _ => {
//     store.set('b')('bar') // No render
...
//   let A = connect(store)(class extends React.Component<Props> {
//     shouldComponentUpdate(p: Props) {
//       return p.store.b !== this.props.store.getState().b || true
//     }
//     render() {
//       renderCount++
//       return this.props.store.a
...
//     constructor(p: Props) {
//       super(p)
//       let _ = this.props.store.b // Trigger read
//     }
//     render() {
//       renderCount++
//       return <>
...
//         <button id='a' onClick={() => this.props.store.set('a')(this.props.store.a + 1)} />
//         <button id='b' onClick={() => this.props.store.set('a')(this.props.store.a - 1)} />
//         {this.props.store.a > 0
//           ? <div>{this.props.store.b}</div>
//           : <span />
//         }
